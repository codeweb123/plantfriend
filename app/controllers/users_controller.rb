    ...
    #Processing form and create new object
      post '/users/signup' do
          ...
          if @user.save
            ...
            flash[:message] = "That username already exist. Please choose another one."
            redirect to '/users/signup'
          elsif
            params[:username] == "" || #check we have bad data
            params[:email] == "" || 
            params[:password] == ""
...
#def authenticate(string)-compares the string to the encrypted (salts & encrypts) password 
#and returns either false or the instance of the user again(true) given by Bcrypt.
